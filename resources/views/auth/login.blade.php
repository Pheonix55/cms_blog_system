...
@section('content')
    <div class="form-container">
        ...
        <form class="form" action="{{ route('loginPost') }}" method="POST">
            ...
            @csrf
            <input type="text" class="input" name="username" placeholder="username" value="{{ old('username') }}">
            @error('username')
            ...
            <p class="page-link">
                <span class="page-link-label"><a href="{{ route('forget_password_view') }}">Forgot Password?</a></span>
            </p>
            <button class="form-btn" type="submit">Log in</button>
        </form>
        <p class="sign-up-label">
            Don't have an account?<span class="sign-up-link"><a href="{{ route('registerView') }}">Sign up</a></span>
        </p>
        <div class="buttons-container">
            ...
            <div class="google-login-button">
                ...
                <span><a href="/auth/google">Log in with Google</a></span>
            </div>
        </div>
    </div>
@endsection
